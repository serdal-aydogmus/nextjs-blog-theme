...
export default function ShareButtons({ title, slug }) {
  ...
  return (
    <div className="flex items-center gap-2 mt-10 pt-8 border-t border-gray-200 dark:border-gray-700">
      <span className="text-xs text-gray-400 dark:text-gray-500 uppercase tracking-wide mr-1">Paylaş</span>
      <a
        href={xHref}
        target="_blank"
